translation_dict = {
    ...
    ' - in page search': '',
    'edit <a class="external" href="https://github.com/TriliumNext/Notes/wiki/Tree concepts#prefix">prefix</a> of active note clone': '',
    'Import into note': '',
    'Choose import file': '',
...
<p>Alternatively you can add label and relation using the <code>+</code> button on the right side.</p>': '',
    ...
    'Add new tab': '',
    'New tab': '',
    "This note of type Book doesn't have any child notes so there's nothing to display. See <a href="https://github.com/TriliumNext/Notes/wiki/Book-note">wiki</a> for details.": '',
    ...
    "See more details on <a href="https://github.com/TriliumNext/Notes/wiki/ETAPI">wiki</a> and <a onclick="window.open('etapi/etapi.openapi.yaml')" href="etapi/etapi.openapi.yaml">ETAPI OpenAPI spec</a>.": '',
    ...
    'See <a href="https://github.com/TriliumNext/Notes/wiki/Default-note-title">wiki with details</a>, API docs for <a href="https://zadam.github.io/trilium/backend_api/Note.html">parentNote</a> and <a href="https://day.js.org/docs/en/display/format">now</a> for details.': '',
