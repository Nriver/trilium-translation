translation_dict = {
    ...
    'Unrecognized type ${defaultType}': '未识别的类型 ${defaultType}',
    'SQL Console note has been saved into ${await treeService.getNotePathTitle(notePath)}': 'SQL控制台笔记已被保存至 ${await treeService.getNotePathTitle(notePath)}',
