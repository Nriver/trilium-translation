translation_dict = {
    ...
    'I have desktop instance already and I want to setup sync with it': '我已经有一个Trilium桌面应用, 我想和它同步数据',
    'I have server instance already and I want to setup sync with it': '我已经有一个Trilium服务端, 我想和它同步数据',
    ...
    'Database has been backed up to ': '数据库已备份到 ',
    ...
    'Multiple shortcuts for the same action can be separated by comma.': '同一个动作的多个快捷键可以用逗号隔开.',
    'Action name': '动作名称',
    'Shortcuts': '快捷键',
    'Default shortcuts': '默认快捷键',
    'Description': '描述',
    'Reload app to apply changes': '重启app以应用修改',
    'Set all shortcuts to the default': '还原全部快捷键到默认值',
    'Type text to filter shortcuts...': '输入关键字来过滤快捷键...',
    'Do you really want to reset all keyboard shortcuts to the default?': '确定要重置所有键盘快捷键吗?',
    'Spell check': '拼写检查',
    ...
    'JPEG quality (0 - worst quality, 100 best quality, 50 - 85 is recommended)': 'JPEG质量 (0最低, 100最好, 推荐设置为50-85之间)',
    ...
    'Options change have been saved.': '设置修改已保存.',
    ...
    'Empty noteId': 'noteId为空',
    '`Not existing branch ${branchId}`': '`不存在的分支 ${branchId}`',
    'Could not find branchId for parent=${parentNoteId}, child=${childNoteId} since child does not exist': '找不到符合 parent=${parentNoteId}, child=${childNoteId} 的branchId, 因为子节点不存在.',
    'Ctrl+Click': 'CTRL+鼠标左键',
    'Text': '文本',
    'Code': '代码',
    'Saved search': '保存的搜索',
    ...
    'frontendStartup - when Trilium frontend starts up (or is refreshed).': '前端启动 - 当Trilium前端启动(或刷新)时.',
    'backendStartup - when Trilium backend starts up': '后端启动 - 当Trilium后端启动.',
    'hourly - run once an hour. You can use additional label <code>runAtHour</code> to specify at which hour.': '每小时 - 每小时一次. 可以通过 <code>runAtHour</code> 标签来指定.',
    'daily - run once a day': '每天 - 每天一次',
    ...
    'Archived': '已归档',
    'Search': '搜索',
    'This note is placed into the following paths:': '这个笔记存放于以下路径:',
    ...
    'No inherited attributes.': '没有继承属性',
    ...
    'Create and link child note "${term}"': '创建并关联子笔记 "${term}"',
    'Insert external link to "${term}"': '插入外部链接到 "${term}"',
    ...
    'Backup now': '立即备份',
    'Backup database now': '现在备份数据库',
    'Database has been backed up to ': '数据库已备份至',
    'Options change have been saved.': '选项更改已保存.',
    'Keyboard shortcuts': '键盘快捷键',
    'Multiple shortcuts for the same action can be separated by comma.': '同一操作的多个快捷方式可以用逗号分隔.',
    'Action name': '动作名称',
    'Shortcuts': '快捷键',
    'Default shortcuts': '默认快捷键',
    'Description': '描述',
