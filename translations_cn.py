translation_dict = {
    ...
    ' - in page search': ' - 页内搜索',
    'edit <a class="external" href="https://github.com/TriliumNext/Notes/wiki/Tree concepts#prefix">prefix</a> of active note clone': '编辑活跃笔记的 <a class="external" href="https://github.com/TriliumNext/Notes/wiki/Tree concepts#prefix">前缀</a>',
    ...
    'Add new tab': '添加新标签',
    'New tab': '新标签页',
    """This note of type Book doesn't have any child notes so there's nothing to display. See <a href="https://github.com/TriliumNext/Notes/wiki/Book-note">wiki</a> for details.""": '这个类型为"书"的笔记没有任何子笔记, 所以什么也不显示. 详见 <a href="https://github.com/TriliumNext/Notes/wiki/Book-note">wiki</a>.',
    ...
    'Render HTML note type is used for <a class="external" href="https://github.com/TriliumNext/Notes/wiki/Scripts">scripting</a>. In short, you have a HTML code note (optionally with some JavaScript) and this note will render it. To make it work, you need to define a <a class="external" href="https://github.com/TriliumNext/Notes/wiki/Attributes">relation</a> called "renderNote" pointing to the HTML note to render.': '笔记类型: 渲染HTML 是用来<a class="external" href="https://github.com/TriliumNext/Notes/wiki/Scripts">编写脚本</a>用的. 简单说就是你可以写HTML代码(或者加上一些JavaScript代码), 然后这个笔记会把页面渲染出来. 你得定义一个叫"renderNote"的<a class="external" href="https://github.com/TriliumNext/Notes/wiki/Attributes">关系</a>来指向要渲染的HTML笔记.',
    'Dim grey': '深灰',
    'Grey': '灰',
    'Light grey': '浅灰',
    'Red': '红',
    ...
    """See more details on <a href="https://github.com/TriliumNext/Notes/wiki/ETAPI">wiki</a> and <a onclick="window.open('etapi/etapi.openapi.yaml')" href="etapi/etapi.openapi.yaml">ETAPI OpenAPI spec</a>.""": """更多信息请访问 <a href="https://github.com/TriliumNext/Notes/wiki/ETAPI">wiki</a> 和 <a onclick="window.open('etapi/etapi.openapi.yaml')" href="etapi/etapi.openapi.yaml">ETAPI OpenAPI 文档</a>.""",
    ...
    'See <a href="https://github.com/TriliumNext/Notes/wiki/Default-note-title">wiki with details</a>, API docs for <a href="https://zadam.github.io/trilium/backend_api/Note.html">parentNote</a> and <a href="https://day.js.org/docs/en/display/format">now</a> for details.': '详见 <a href="https://github.com/TriliumNext/Notes/wiki/Default-note-title">wiki</a>. <a href="https://zadam.github.io/trilium/backend_api/Note.html">parentNote</a> 和 <a href="https://day.js.org/docs/en/display/format">now</a> 的API文档.',
