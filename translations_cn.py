translation_dict = {
    ...
    'Keyboard launcher for this launcher action can be configured in Options -> Launchers.': '此启动器的快捷键可以在 选项 -> 启动器 中配置.',
    ...
    ' - optional, pressing the keyboard launcher will open the note': '- 可选, 按下键盘快捷键将打开笔记',
    'Launchbar displays the title / icon from the launcher which does not necessarily mirrors those of the target note.': '启动栏显示启动器的标题/图标, 不一定是目标笔记的标题/图标.',
    ...
    ' - optional, pressing the keyboard launcher will activate the launcher': '- 可选, 按下键盘快捷键将激活启动器',
    'Example script': '示例脚本',
    ...
    'Erase attachments after X seconds of not being used in its note': '在附件在笔记中未被使用 X 秒后清除附件',
